...
resource "azurerm_postgresql_flexible_server" "postgresql" {
  ...
  administrator_login          = try(var.postgresql.create_mode, "Default") == "Default" || try(var.postgresql.auth.pw_auth_enabled, null) == true ? "replace(${var.postgresql.name}_admin, "-", "_")" : null
